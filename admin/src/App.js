...
const initialClients = [
  {
    ...
    goals: [
      {
        text: "Establish regular sleep routine",
        completed: true,
      },
      {
        text: "Reduce anxiety symptoms",
        completed: false,
      },
      {
        text: "Improve emotional regulation",
        completed: false,
      },
      {
        text: "Reduce procrastination",
        completed: false,
      },
    ],
...

  {
    ...
    goals: [
      ...
      {
        text: "Develop stress management strategies",
        completed: true,
      },
    ],
    sessions: [],
  ...
  const completeSession = (completedSession) => {
    setClients((prevClients) =>
      prevClients.map((client) => {
        if (client.id !== completedSession.clientId) {
          return client;
        }
        return {
          ...client,
            ...
            <div>
              ...
              <div className="mt-4">
                ...
                <div className="flex flex-wrap gap-2 mt-2">
                  ...
                  {client.sessions[0].interventions.map(
                    (item) => (
                      <span
                        key={item}
    ...
    <div className="space-y-5">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={onClose}
            className="px-4 py-2.5 rounded-xl bg-slate-100 text-sm font-medium"
          >
            End Session
          </button>
      ...
      >
        ...
        <div className="grid md:grid-cols-2 gap-5">
          ...
          <SessionTextArea
            label="Session Focus"
            value={clientNotes.sessionFocus}
            onChange={(value) =>
              updateNote(
                "sessionFocus",
                value
          ...
          <SessionTextArea
            ...
            value={
              clientNotes.presentingConcerns
            }
            onChange={(value) =>
              updateNote(
                "presentingConcerns",
        ...
        <div className="flex justify-end gap-2 mt-6 pt-5 border-t border-slate-100">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-slate-50 text-sm font-medium"
          >
            <Save size={15} />
            Save Draft
          </button>
      ...
      >
        ...
        <GoalList
          goals={[
            ...
            {
              text: "Improve daily functioning",
              completed: false,
            },
          ]}
        />
...
function CheckOption({
  ...
  return (
    <label className="flex items-center gap-3 text-sm text-slate-600">
      ...
      <input
        type="checkbox"
        className="w-4 h-4 accent-[#087F7B]"
      />
    ...
    <div className="min-h-[70vh] flex items-center justify-center">
      ...
      <div className="text-center">
        ...
        <p className="text-sm text-slate-400 mt-2 max-w-sm">
          This module is ready to be connected to the Psychobeings clinical workflow.
        </p>
