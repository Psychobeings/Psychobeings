            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                ...
                <div className="lg:col-span-7 flex flex-col items-start space-y-6">
                    ...
                    <p className="text-base sm:text-lg text-gray-700 max-w-2xl leading-relaxed font-sans">
                     At Psychobeings, we believe that every individual deserves a safe space to be heard, understood, and empowered. Through evidence-based psychological therapy and holistic wellbeing practices, we support you in overcoming life's challenges, strengthening emotional resilience, and creating meaningful, lasting change.

                    Sessions available in English and Hindi. Secure online counselling across India and in-person appointments in Faridabad, Haryana
