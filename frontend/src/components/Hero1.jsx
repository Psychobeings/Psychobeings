            ...
            <div className="lg:col-span-7 space-y-6 text-left">
              ...
              <div className="space-y-4 text-slate-600 leading-relaxed text-sm sm:text-base font-light">
                ...
                <div className="flex flex-wrap gap-4 pt-2">
                  <Link
                    to="/booking"
                    className="px-6 py-3 rounded-full bg-[#0a7272] hover:bg-[#0d5c5e] text-white font-medium text-sm transition-all duration-200 shadow-md inline-block"
                  >
                    Book a Session
                  </Link>
                  <Link
                    to="/services"
                    className="px-6 py-3 rounded-full bg-white border border-slate-200 text-slate-700 hover:bg-slate-50 hover:border-teal-200 font-medium text-sm transition-all duration-200 inline-block"
                  >
                    Explore Services
                  </Link>
                  <Link
                    to="/about"
                    className="px-6 py-3 rounded-full text-slate-600 hover:text-slate-950 font-medium text-sm transition-all duration-200 inline-block"
                  >
                    Learn More &rarr;
                  </Link>
                </div>
