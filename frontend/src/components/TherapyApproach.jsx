      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        >
          <div className="inline-block">
            ...
            <div className="w-32 h-1 bg-gradient-to-r from-teal-600 to-teal-400 mx-auto rounded-full" />
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          {APPROACHES.map((approach, index) => (
            <div
              ...
              className={`group relative bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl border border-gray-100 hover:border-teal-200 transition-all duration-500 cursor-pointer transform hover:-translate-y-1 ${
                isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
              }`}
            >
              {/* Glowing background effect on hover */}
              <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-teal-100/50 to-teal-50/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />

              <div className="relative z-10">
                <div className="flex items-start space-x-4 mb-4">
                  <div 
                    aria-hidden="true"
                    className="text-4xl bg-gradient-to-br from-teal-100 to-teal-200 rounded-full w-16 h-16 flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-md shrink-0"
                  >
                    {approach.icon}
                  </div>
                ...
                {/* Hover indicator bar */}
                <div className="mt-4 h-0.5 w-8 group-hover:w-16 bg-gradient-to-r from-teal-500 to-teal-400 rounded-full transition-all duration-300" />
              </div>
            </div>
          ))}
        </div>
        ...
        >
          ...
          <div className="flex justify-center items-center">
            <Link 
              to="/booking" 
              className="group relative inline-flex items-center space-x-2 px-10 py-4 bg-gradient-to-r from-teal-600 to-teal-500 text-white font-bold text-lg rounded-full shadow-2xl hover:shadow-teal-500/25 transform hover:scale-105 transition-all duration-300 overflow-hidden"
            >
