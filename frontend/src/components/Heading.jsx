            ...
            <div className="grid grid-cols-1 gap-16 md:gap-24">
              <div className="grid grid-cols-1 gap-8 md:grid-cols-2 items-center">
                <div className="flex flex-col justify-center gap-6">
                  ...
                  <p className="text-lg text-gray-600">
                    Find the perfect parking spot in real-time with our advanced
                    AI-powered system. Say goodbye to circling blocks and hello
                    to stress-free parking. Whether you're in a crowded city or
                    at a busy event, our smart parking management system ensures
              ...
              <div className="grid grid-cols-1 gap-8 md:grid-cols-2 items-center">
                ...
                <div className="order-1 md:order-2 flex flex-col justify-center gap-6">
                  ...
                  <p className="text-lg text-gray-600">
                    Seamlessly pay for parking using our secure, contactless
                    payment system. No more fumbling for change or racing back
                    to the meter. Our user-friendly interface makes transactions
                    quick and hassle-free, ensuring a smooth parking experience
              ...
              <div className="grid grid-cols-1 gap-8 md:grid-cols-2 items-center">
                <div className="flex flex-col justify-center gap-6">
                  ...
                  <p className="text-lg text-gray-600">
                    For lot owners: Optimize your parking space utilization with
                    our comprehensive management tools. Increase efficiency and
                    boost revenue. Our system provides real-time analytics,
                    automated reporting, and customizable pricing strategies to
