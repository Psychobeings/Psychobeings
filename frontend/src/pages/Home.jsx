...
const homeSections = [WhatWeDo, LanguageSupport, FoundersNote, HowTherapyWorks, CareAssessment, FeaturedServices, Testimonials, FAQ];

const Home = () => {
  return (
    <div
      className="min-h-screen bg-gradient-to-b from-[#FBFEFD] via-[#F8FCFB] to-[#F2F8F7] text-[#1f3a3d]"
    >
      <Hero1 />
